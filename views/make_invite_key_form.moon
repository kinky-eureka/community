...
class extends Widget
  content: =>
    if @invkey
      ...
      img style: "display: block; margin: 10px auto;width: 300px", src: "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chld=M|3&choe=UTF-8&chl="..escape("http://kinky-eureka.com/users/register?uname="..escape(@params.username).."&key="..escape(@invkey))
